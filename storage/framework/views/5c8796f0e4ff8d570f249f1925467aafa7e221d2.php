...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" type="text/js" href="<?php echo e(asset('js/app.js')); ?>">
        <!-- Styles -->
        <style>
            html, body {
    ...
    <div class="card" style="background-color: rgb(7, 8, 88)">
      ...
      <div class="card-body">
        ...
        <hr style="background-color: white;">
                <br>
        <ul class="col-md-12">
                    <li class="text-danger text-center"> <a href="<?php echo e(url('formresind')); ?>" class="text-danger"> Formulario Individual</a></li>
                </ul>
      </div> 
    ...
    <div class="card" style="background-color: rgb(7, 8, 88)">
      ...
      <div class="card-body">
        ...
        <hr style="background-color: white;">
                <br>
      <ul class="col-md-12">
                    <li class="text-danger text-center"> <a href="<?php echo e(url('formresgrup')); ?>" class="text-danger"> Formulario Grupal</a></li>
                </ul>
      </div>
    ...
    <div class="card" style="background-color: rgb(7, 8, 88)">
      ...
      <div class="card-body">
        ...
        <hr style="background-color: white;">
                <br>
     <ul class="col-md-12">
                    <li class="text-danger text-center"> <a href="<?php echo e(url('formvolind')); ?>" class="text-danger"> Formulario Individual</a></li>
                </ul>
      </div> 
    ...
    <div class="card" style="background-color: rgb(7, 8, 88)">
      ...
      <div class="card-body">
        ...
        <hr style="background-color: white;">
                <br>
      <ul class="col-md-12">
                    <li class="text-danger text-center"> <a href="<?php echo e(url('formvolgrup')); ?>" class="text-danger"> Formulario Grupal</a></li>
                </ul>
      </div>
        ...
        <div class="row " style="background-color: rgb(7, 8, 88)">
            ...
            <div class="col-md-6 text-center">
                ...
                <ul class="col-md-12">
                    ...
                    <img src="<?php echo e(asset('images/facebook.png')); ?>" class="img-fluid" width="35px" alt="facebook unacemede">
                    </a>
                    <a href="https://www.instagram.com/unacemede/">
                    <img src="<?php echo e(asset('images/instagram.png')); ?>" class="img-fluid" width="35px" alt="instagram unacemede">
                    </a> 
                    <a href="https://www.youtube.com/channel/UCEm2F4ZxRBORG3IztQAqnyQ"> 
                    <img src="<?php echo e(asset('images/youtube.png')); ?>" class="img-fluid" width="35px" alt="youtube unacemede"> 
                    </a>
                    </div>  
                  </div> 
                </ul> 
...
<?php /**PATH C:\xampp\htdocs\APP_SENDERO_CORNIZUELO-master\resources\views/servicios.blade.php ENDPATH**/ ?>
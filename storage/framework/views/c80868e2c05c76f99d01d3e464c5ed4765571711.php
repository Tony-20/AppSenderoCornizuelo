            ...
            <?php if(Route::has('login')): ?>
                <div class="top-right links">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('almacen')); ?>">Almacen</a>
                    <?php else: ?>
...
<div class="card-group">
    <div class="card" style="background-color: rgb(7, 8, 88)">
      ...
      <div class="card-body">
        <h2 class="card-title text-white text-center" style="font-weight: bold;"><a href="<?php echo e(url('flora')); ?>">Flora</a></h2>
    ...
    <div class="card" style="background-color: rgb(7, 8, 88)">
      ...
      <div class="card-body">
        <h2 class="card-title text-white text-center" style="font-weight: bold;"><a href="<?php echo e(url('fauna')); ?>">Fauna</a></h2> 
...
<?php /**PATH C:\xampp\htdocs\APP_SENDERO_CORNIZUELO-master\resources\views/inicio.blade.php ENDPATH**/ ?>
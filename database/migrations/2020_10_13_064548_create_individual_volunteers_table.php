...
class CreateIndividualVolunteersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('individual_volunteers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('individual_volunteers');
    }
}
